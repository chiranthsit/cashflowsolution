...
<!-- Favicons -->
<link href="${pageContext.request.contextPath}/assets/img/logo.jpg"
	rel="icon">
<!-- Google Fonts -->
<link
...
<link
	href="${pageContext.request.contextPath}/assets/vendor/bootstrap/css/selectize.bootstrap4.css"
	rel="stylesheet">
...
<link href="${pageContext.request.contextPath}/assets/css/styleOne.css"
	rel="stylesheet">

<link
	href="${pageContext.request.contextPath}/assets/css/jquerysctipttop.css"
	rel="stylesheet">

<!-- bootstrap-datetimepicker -->
<link
	href="${pageContext.request.contextPath}/assets/vendor/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css"
	rel="stylesheet">
</head>
<body>
	<jsp:include page="topnav1.jsp" />
	...
	<script
		src="${pageContext.request.contextPath}/assets/vendor/bootstrap/js/selectize.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/vendor/bootstrap/js/selectize.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/assets/vendor/popper/js/popper.min.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/assets/vendor/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>

	<!-- Template Main JS File -->
	<script src="${pageContext.request.contextPath}/assets/js/main.js"></script>
	<script src="${pageContext.request.contextPath}/assets/js/cityNames.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/js/selectdates.js"></script>
